...
//i keep using ur shit xd sorry meteor devs
...
public class EnemyArgumentType implements ArgumentType<String> {
    ...
    public static String get(CommandContext<?> context) throws Exception {
        if(Friends.Companion.isHostile(context.getArgument("player", String.class))) {
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
        return suggestMatching(Friends.Companion.getHostileList().stream(), builder);
    }
